---
name: starbucks-use-watermark
description: "Starbucks UI useWatermark hook API. Use for rendering dynamic canvas-based watermarks with text/image support, rotation, custom fonts, and MutationObserver tamper protection."
