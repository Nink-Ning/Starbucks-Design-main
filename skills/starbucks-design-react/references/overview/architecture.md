---
name: starbucks-design-architecture
description: "Starbucks UI component architecture and design patterns. Use for understanding component structure, controlled/uncontrolled patterns, props merging, sub-component patterns (Component.SubComponent), and ref forwarding."
...
form.setFieldsValue({ name: 'Starbucks' });
form.validate();
form.resetFields();
form.getFieldsValue();
...
1. **始终从主入口导入** `@sbux/starbucks-design-react`，配合 tree-shaking
