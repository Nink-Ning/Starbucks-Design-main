---
name: starbucks-config-provider
description: "Starbucks UI ConfigProvider API guide. Use for global component configuration — size, theme, locale, default props, and prefixCls customization."
