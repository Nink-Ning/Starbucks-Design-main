---
name: starbucks-controlled-uncontrolled
description: "Starbucks UI controlled vs uncontrolled component patterns. Use for understanding value/onChange (controlled) vs defaultValue (uncontrolled) state management."
...
Starbucks UI 中所有有状态的组件同时支持**受控**和**非受控**两种模式。
