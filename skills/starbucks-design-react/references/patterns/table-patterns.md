---
name: starbucks-table-patterns
description: "Starbucks UI table patterns and best practices. Use for remote data loading, editable table rows, virtual scroll for large datasets, custom filters, and row selection."
user-invocable: false
---

# 表格模式

Starbucks UI Table 组件的常见使用模式。
