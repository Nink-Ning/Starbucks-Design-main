---
name: starbucks-form-patterns
description: "Starbucks UI form patterns and best practices. Use for dynamic forms, field validation, linked validation, nested forms, async form submission, and complex form layouts."
user-invocable: false
---

# 表单模式

Starbucks UI Form 组件的常见使用模式。
