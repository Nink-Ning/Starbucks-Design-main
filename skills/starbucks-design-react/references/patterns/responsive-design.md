---
name: starbucks-responsive-design
description: "Starbucks UI responsive design guide. Use for Grid breakpoints (xs/sm/md/lg/xl/xxl), responsive layout, and adaptive page design."
