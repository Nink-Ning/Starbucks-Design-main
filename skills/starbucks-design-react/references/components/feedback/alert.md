---
name: starbucks-alert
description: "Starbucks UI Alert component API. Use for inline alert banners — info, success, warning, error messages with optional close button and actions."
