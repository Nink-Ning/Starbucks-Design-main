---
name: starbucks-progress
description: "Starbucks UI Progress component API. Use for linear progress bars, circular progress, step progress, and custom status display."
