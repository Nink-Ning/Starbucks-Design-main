---
name: starbucks-skeleton
description: "Starbucks UI Skeleton component API. Use for loading skeleton placeholders with text rows, image blocks, and animation."
