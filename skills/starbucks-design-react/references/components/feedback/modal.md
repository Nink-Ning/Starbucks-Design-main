---
name: starbucks-modal
description: "Starbucks UI Modal component API. Use for modal dialogs, Modal.confirm() confirmation, Modal.info/success/warning/error, useModal hook, and form-in-modal patterns. Use unmountOnExit to reset form state."
