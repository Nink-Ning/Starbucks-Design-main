---
name: starbucks-message
description: "Starbucks UI Message component API. Use for global toast messages — success, error, warning, info, and loading feedback at page top."
