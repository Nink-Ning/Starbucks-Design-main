---
name: starbucks-page-header
description: "Starbucks UI PageHeader component API. Use for page titles with back button, breadcrumb, subtitle, and action buttons."
