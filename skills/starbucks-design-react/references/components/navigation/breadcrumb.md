---
name: starbucks-breadcrumb
description: "Starbucks UI Breadcrumb component API. Use for page navigation hierarchy, route-based breadcrumbs, and dropdown breadcrumbs."
