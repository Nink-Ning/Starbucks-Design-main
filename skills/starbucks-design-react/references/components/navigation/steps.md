---
name: starbucks-steps
description: "Starbucks UI Steps component API. Use for step-by-step workflows, vertical steps, dot-style steps, and error state indicators."
