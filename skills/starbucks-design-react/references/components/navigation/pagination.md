---
name: starbucks-pagination
description: "Starbucks UI Pagination component API. Use for page navigation, page size switching, simple/mini pagination, and custom total display."
