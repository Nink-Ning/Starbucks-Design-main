---
name: starbucks-watermark
description: "Starbucks UI Watermark component API. Use for adding text or image watermarks over page content."
...
<Watermark content="Starbucks UI">
...
// 多行水印
<Watermark content={['Starbucks UI', '字节跳动']}>
  <div>内容</div>
</Watermark>
```
