---
name: starbucks-space
description: "Starbucks UI Space component API. Use for consistent horizontal/vertical spacing between elements, with wrap and split support."
