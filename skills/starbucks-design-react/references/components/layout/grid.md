---
name: starbucks-grid
description: "Starbucks UI Grid (Row/Col) layout API. Use for 24-column grid system, responsive breakpoints (xs/sm/md/lg/xl/xxl), gutter spacing, and flex alignment."
