---
name: starbucks-input-number
description: "Starbucks UI InputNumber component API. Use for numeric input, stepper, precision control, min/max range, and formatter."
