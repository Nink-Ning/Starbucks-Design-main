---
name: starbucks-checkbox
description: "Starbucks UI Checkbox component API. Use for multiple selection, Checkbox.Group, select all / indeterminate state, and controlled checkbox."
