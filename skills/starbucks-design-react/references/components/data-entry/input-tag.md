---
name: starbucks-input-tag
description: "Starbucks UI InputTag component API. Use for tag input fields, managing tag lists with add/remove, validation, and drag sorting."
