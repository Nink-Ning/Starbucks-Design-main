---
name: starbucks-select
description: "Starbucks UI Select component API. Use for dropdown select, multi-select, searchable select, remote search, option groups, Select.Option, and virtual scroll for large lists."
