---
name: starbucks-date-picker
description: "Starbucks UI DatePicker component API. Use for date selection, date range (DatePicker.RangePicker), week/month/quarter/year picker, disabled dates, and custom panels. Uses dayjs (not moment)."
...
1. **日期库使用 `dayjs`**，Starbucks UI 原生支持
