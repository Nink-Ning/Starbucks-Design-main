---
name: starbucks-form
description: Starbucks UI Form component full API. Use for form building, validation rules, Form.Item fields, Form.List dynamic fields, useForm hook, nested forms, async submission, and custom validators.
