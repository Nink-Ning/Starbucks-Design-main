---
name: starbucks-transfer
description: "Starbucks UI Transfer component API. Use for transferring items between two lists, searchable transfer, simple mode, and custom rendering."
