---
name: starbucks-switch
description: "Starbucks UI Switch component API. Use for toggle switches, loading state, checked/unchecked text, and async toggle. In Form use triggerPropName='checked'."
