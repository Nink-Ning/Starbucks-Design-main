---
name: starbucks-input
description: "Starbucks UI Input component API. Use for text input, password input (Input.Password), search box (Input.Search), textarea (Input.TextArea), input groups, and prefix/suffix addons."
