---
name: starbucks-verification-code
description: "Starbucks UI VerificationCode component API. Use for OTP / verification code input fields with configurable length."
