---
name: starbucks-upload
description: "Starbucks UI Upload component API. Use for file upload, drag-and-drop upload, image upload with preview, custom upload logic, and upload list management."
