---
name: starbucks-tree-select
description: "Starbucks UI TreeSelect component API. Use for selecting from tree structure data, tree checkboxes, searchable tree, and async node loading."
