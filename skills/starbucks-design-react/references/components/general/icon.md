---
name: starbucks-icon
description: "Starbucks UI Icon component usage. Use for built-in icons, custom SVG icons, and IconFont integration."
user-invocable: false
---

# Icon 图标

Starbucks UI 图标库，作为独立包 `@arco-design/web-react/icon` 提供。
