---
name: starbucks-link
description: "Starbucks UI Link component API. Use for hyperlinks, icon links, and styled navigation links."
...
<StarbucksLink onClick={() => navigate('/about')}>关于我们</StarbucksLink>
