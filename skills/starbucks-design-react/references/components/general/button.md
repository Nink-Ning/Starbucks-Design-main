---
name: starbucks-button
description: "Starbucks UI Button component API and usage. Use for buttons, button groups, icon buttons, loading buttons, and link-style buttons in React."
