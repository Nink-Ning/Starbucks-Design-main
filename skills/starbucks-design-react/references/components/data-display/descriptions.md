---
name: starbucks-descriptions
description: "Starbucks UI Descriptions component API. Use for key-value detail display (detail pages), vertical/horizontal layout, bordered descriptions, and responsive columns."
