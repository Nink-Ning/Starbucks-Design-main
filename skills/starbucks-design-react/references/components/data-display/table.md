---
name: starbucks-table
description: "Starbucks UI Table component full API. Use for data tables with sorting, filtering, pagination, fixed columns/headers, virtual scroll, row selection, expandable rows, tree data, and custom cell rendering."
