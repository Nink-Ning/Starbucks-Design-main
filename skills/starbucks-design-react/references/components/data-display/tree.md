---
name: starbucks-tree
description: "Starbucks UI Tree component API. Use for tree structure display, checkable tree, draggable nodes, virtual scroll tree, async loading, and custom tree node rendering."
