---
name: starbucks-design-react
description: "Starbucks UI React component library reference (@sbux/starbucks-design-react) — a Starbucks-themed wrapper around Arco Design. Use this skill whenever the user asks to build a page, create a UI, write frontend code, develop a web application, design a dashboard, or implement any React interface. Covers all 70 components with full API, code examples, import patterns, theming, i18n, layout, forms, tables, modals, navigation, data entry, data display, feedback, responsive design, and best practices."
---

# Starbucks UI React — Skills Reference

`@sbux/starbucks-design-react` — An enterprise-level React UI component library built on Arco Design.

## Critical Conventions

**Always follow these rules when writing Starbucks UI code:**

- **Imports**: `import { Button, Table, Form } from '@sbux/starbucks-design-react'` — always from the package root, never from sub-paths like `@sbux/starbucks-design-react/es/Button`
- **Icons**: `import { IconSearch, IconPlus } from '@sbux/starbucks-design-react/icon'`
- **Types**: `import type { TableProps, FormInstance } from '@sbux/starbucks-design-react'`
- **Styles**: `import '@sbux/starbucks-design-react/dist/css/starbucks.css'` (full) or configure on-demand loading
...
|-------|------|-------------|
| Installation | [getting-started.md](references/overview/getting-started.md) | Install `@sbux/starbucks-design-react`, import styles, configure tree-shaking or babel-plugin-import |
