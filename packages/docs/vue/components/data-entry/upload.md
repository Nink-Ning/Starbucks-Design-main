...
<preview path="./demos/upload/avatar-upload.vue" title="用户头像上传"></preview>
...
<preview path="./demos/upload/basic-usage.vue" title="基本使用"></preview>
...
<preview path="./demos/upload/before-remove.vue" title="移除前校验"></preview>
...
<preview path="./demos/upload/before-upload.vue" title="上传前校验"></preview>
...
<preview path="./demos/upload/custom-upload-node.vue" title="自定义上传节点"></preview>
...
<preview path="./demos/upload/custom-icon.vue" title="自定义图标"></preview>
...
<preview path="./demos/upload/folder-upload.vue" title="文件夹上传"></preview>
...
<preview path="./demos/upload/drag-upload.vue" title="拖拽上传"></preview>
...
<preview path="./demos/upload/limit-upload.vue" title="限制上传数量"></preview>
...
<preview path="./demos/upload/picture-wall.vue" title="照片墙"></preview>
...
<preview path="./demos/upload/icon-list-style.vue" title="图标列表样式"></preview>
...
<preview path="./demos/upload/custom-upload-request.vue" title="自定义上传请求"></preview>
...
<preview path="./demos/upload/manual-upload.vue" title="手动上传"></preview>
...
<preview path="./demos/upload/file-list.vue" title="已上传的文件列表"></preview>
