...
<preview path="./demos/transfer/basic-usage.vue" title="基本使用"></preview>
...
<preview path="./demos/transfer/custom-title-bar.vue" title="自定义标题栏"></preview>
...
<preview path="./demos/transfer/custom-option-render.vue" title="自定义选项渲染"></preview>
...
<preview path="./demos/transfer/one-way.vue" title="单向"></preview>


## 分页

<preview path="./demos/transfer/pagination.vue" title="分页"></preview>
...
<preview path="./demos/transfer/search.vue" title="搜索"></preview>
...
<preview path="./demos/transfer/simple.vue" title="简单模式"></preview>
...
<preview path="./demos/transfer/tree-transfer.vue" title="树型穿梭框"></preview>
