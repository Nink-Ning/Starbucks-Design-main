...
<preview path="./demos/input-tag/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/input-tag/max-tags.vue" title="最多展示标签数量"></preview>
...
<preview path="./demos/input-tag/input-size.vue" title="输入框尺寸"></preview>
...
<preview path="./demos/input-tag/input-status.vue" title="输入框状态"></preview>
