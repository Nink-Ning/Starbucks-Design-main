...
<preview path="./demos/time-picker/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/time-picker/v-model.vue" title="双向绑定"></preview>
...
<preview path="./demos/time-picker/default-value.vue" title="默认值"></preview>
...
<preview path="./demos/time-picker/skip-confirm.vue" title="跳过确认"></preview>
...
<preview path="./demos/time-picker/disabled-time.vue" title="禁用部分时间选项"></preview>
...
<preview path="./demos/time-picker/disabled.vue" title="禁用"></preview>
...
<preview path="./demos/time-picker/extra-content.vue" title="附加内容"></preview>
...
<preview path="./demos/time-picker/custom-format.vue" title="定制格式"></preview>
...
<preview path="./demos/time-picker/prefix.vue" title="前缀"></preview>
...
<preview path="./demos/time-picker/range-picker.vue" title="范围选择器"></preview>
...
<preview path="./demos/time-picker/size.vue" title="尺寸"></preview>
...
<preview path="./demos/time-picker/custom-step.vue" title="定制步长"></preview>
...
<preview path="./demos/time-picker/12-hour.vue" title="十二小时制"></preview>
