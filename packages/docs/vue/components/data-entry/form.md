...
<preview path="./demos/form/async-validation.vue" title="表单异步校验"></preview>
...
<preview path="./demos/form/auto-label-width.vue" title="自动标签宽度"></preview>
...
<preview path="./demos/form/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/form/custom-form-component.vue" title="自定义表单组件"></preview>
...
<preview path="./demos/form/global-disabled.vue" title="全局禁用"></preview>
...
<preview path="./demos/form/dynamic-form.vue" title="动态表单"></preview>
...
<preview path="./demos/form/extra-info.vue" title="额外信息和帮助信息"></preview>
...
<preview path="./demos/form/grid-layout.vue" title="栅格布局"></preview>
...
<preview path="./demos/form/form-layout.vue" title="表单布局"></preview>
...
<preview path="./demos/form/nested-data.vue" title="嵌套数据"></preview>
...
<preview path="./demos/form/scroll-to-field.vue" title="滚动到指定表单字段"></preview>
...
<preview path="./demos/form/custom-form-validation.vue" title="自定义表单校验状态"></preview>
...
<preview path="./demos/form/form-validation.vue" title="验证表单"></preview>
...
<preview path="./demos/form/form-validation-2.vue" title="验证表单2"></preview>
