...
<preview path="./demos/popconfirm/async-close.vue" title="异步关闭"></preview>
...
<preview path="./demos/popconfirm/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/popconfirm/custom-button.vue" title="自定义按钮"></preview>
...
<preview path="./demos/popconfirm/popup-position.vue" title="弹出位置"></preview>
...
<preview path="./demos/popconfirm/confirm-type.vue" title="确认框类型"></preview>
