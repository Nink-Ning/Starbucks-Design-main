...
<preview path="./demos/modal/async-close.vue" title="异步关闭"></preview>
...
<preview path="./demos/modal/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/modal/confirm-dialog.vue" title="确认对话框"></preview>
...
<preview path="./demos/modal/custom-button-text.vue" title="定制按钮文字"></preview>
...
<preview path="./demos/modal/draggable.vue" title="可拖动"></preview>
...
<preview path="./demos/modal/popup-form.vue" title="弹出层表单"></preview>
...
<preview path="./demos/modal/fullscreen.vue" title="全屏"></preview>
...
<preview path="./demos/modal/function-call.vue" title="函数调用"></preview>
...
<preview path="./demos/modal/message-tip.vue" title="消息提示"></preview>
...
<preview path="./demos/modal/dialog-width.vue" title="对话框的宽度"></preview>
