...
<preview path="./demos/resize-box/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/resize-box/controlled-size.vue" title="受控的高宽"></preview>
...
<preview path="./demos/resize-box/custom-resize-bar.vue" title="定制伸缩杆内容"></preview>
...
<preview path="./demos/resize-box/in-layout.vue" title="在布局中使用"></preview>
