...
<preview path="./demos/statistic/number-animation.vue" title="数值动画"></preview>
...
<preview path="./demos/statistic/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/statistic/countdown.vue" title="倒计时组件"></preview>
...
<preview path="./demos/statistic/custom-prefix-suffix.vue" title="自定义前缀&后缀"></preview>
