...
<preview path="./demos/tabs/basic.vue" title="基本用法"></preview>
...
<preview path="./demos/tabs/dynamic-tabs.vue" title="动态增减标签页"></preview>
...
<preview path="./demos/tabs/extra-content.vue" title="附加内容"></preview>
...
<preview path="./demos/tabs/tab-with-icon.vue" title="带图标的页签"></preview>
...
<preview path="./demos/tabs/lazy-load.vue" title="懒加载"></preview>
...
<preview path="./demos/tabs/placement.vue" title="位置"></preview>
...
<preview path="./demos/tabs/scroll.vue" title="滚动"></preview>
...
<preview path="./demos/tabs/trigger.vue" title="触发方式"></preview>
...
<preview path="./demos/tabs/variants.vue" title="不同类型"></preview>
