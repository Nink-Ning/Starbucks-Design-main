...
export default function Demo() {
  const [activeValues, setActiveValues] = useState<FilterValue>(defaultValue);
  ...
  return (
    <div className="sb-filter-bar-demo sb-filter-bar-demo--layout sb-filter-bar-demo--integrated">
      <div className="sb-filter-bar-demo__filter-module">
        <FilterBar
          fields={fields}
      ...
      <div className="sb-filter-bar-demo__result-module">
