<template>
  ...
  <Space direction="vertical" style="margin-top: 10px">
    <Countdown
      ...
      @finish="handleFinish"
    />
    <Button @click="start = true" type="primary">Start</Button>
  </Space>
</template>
...
// scripts/docs-migration/RULES.md rule 5 for why this is required.
...
const handleFinish = () => {
  Message.info('Finish', appContext);
};
</script>
