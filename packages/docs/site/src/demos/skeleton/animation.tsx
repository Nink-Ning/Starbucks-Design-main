...
import { Skeleton, Switch, Avatar, Typography } from '@sbux/starbucks-design-react';
  ...
  render() {
    return (
      <div>
        ...
        <Skeleton loading={this.state.loading} text={{ width: '90%' }} image={{ shape: 'circle' }} animation>
