<template>
  <div :style="{ display: 'flex' }">
    <Timeline :style="{ marginRight: '40px' }">
      <TimelineItem label="2020-04-12" dotColor="#00B42A">
        The first milestone
      </TimelineItem>
      <TimelineItem label="2020-05-17">
...
import { IconCheck, IconClockCircle } from '@sbux/starbucks-design-vue/icon';
</script>
