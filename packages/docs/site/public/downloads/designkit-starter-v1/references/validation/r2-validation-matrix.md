# Starter V1-r2 Final Validation Matrix

This filtered matrix records final R2 evidence independently. `PASS` in one dimension never promotes another dimension. `CONDITIONAL` means an explicit dependency or manual sign-off remains.
