...
export interface TableToolbarProps {
  ...
  className?: string
  style?: CSSProperties
  onQuickFilterChange?: (values: TableToolbarQuickFilterValues, meta: TableToolbarQuickFilterEventMeta) => void
  onSearchSubmit?: (
    keyword: string,
    values: TableToolbarQuickFilterValues,
    meta: TableToolbarQuickFilterEventMeta
  ) => void
  onOperation?: (actionKey: string, meta: TableToolbarOperationEventMeta) => void
  onExport?: (meta: TableToolbarToolEventMeta) => void
  onColumnSettings?: (meta: TableToolbarToolEventMeta) => void
  onRefresh?: (meta: TableToolbarToolEventMeta) => void
}
